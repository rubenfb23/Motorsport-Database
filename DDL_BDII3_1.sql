...
CREATE TABLE EMPLEADOS(
    ...
    ESCUDID VARCHAR2(15),
    ID_DIRIGENTE VARCHAR(9),
    JOB VARCHAR(15) NOT NULL,
    PRIMARY KEY(DNI),
    FOREIGN KEY (ID_DIRIGENTE) REFERENCES EMPLEADOS,
    FOREIGN KEY(ESCUDID) REFERENCES ESCUD,
...
CREATE OR REPLACE VIEW V_TECNICOS   
    AS SELECT ESPECIALIZACION, COUNT(*) AS TECNICOS
    FROM TECNICOS 
...
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('53817417Q', '14-01-2020', 'AVENIDA', '12347G', '1550', 'LAURA', 'DIEGO', '1234G', '53817417Q', 'DIRIGENTE');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('11111111A', '14-01-2020', 'AVENIDA', '12345G', '1550', 'PACO', 'JUAN', '1234G', '53817417Q', 'ANALISTA');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('21111111A', '14-01-2020', 'AVENIDA', '22345G', '1550', 'PEDRO', 'JUAN', '1234G', '53817417Q', 'ANALISTA');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('31111111A', '14-01-2020', 'AVENIDA', '32345G', '1550', 'LUCIA', 'JUAN', '1234G', '53817417Q', 'ANALISTA');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('41111111A', '14-01-2020', 'AVENIDA', '42345G', '1550', 'SARA', 'JUAN', '1234G', '53817417Q', 'TECNICO');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('51111111A', '14-01-2020', 'AVENIDA', '42145G', '1550', 'SARA', 'JUAN', '1234G', '53817417Q', 'TECNICO');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('61111111A', '14-01-2020', 'AVENIDA', '43345G', '1550', 'SARA', 'JUAN', '1234G', '53817417Q', 'TECNICO');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('71111111A', '14-01-2020', 'AVENIDA', '46345G', '1550', 'SARA', 'JUAN', '1234G', '53817417Q','TECNICO');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('12345678A', '14-01-2020', 'AVENIDA', '42375G', '1550', 'PABLO', 'JUAN', '1234G', '53817417Q', 'PILOTO');
INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB) VALUES('12345679A', '14-01-2020', 'AVENIDA', '4237GG', '1550', 'SARAY', 'JUAN', '1234G', '53817417Q', 'PILOTO');
...
/*UPDATE V_TECNICOS SET ESPECIALIZACION='FRENOS' WHERE ESPECIALIZACION='NEUMATICOS';*/
...
BEGIN
    ...
    v_numero := MOD(v_numero,23);
    letra_correcta := SUBSTR(v_letras, v_numero+1, 1);
    IF letra_correcta != v_letra THEN
        RETURN 'FALSE';
    END IF;
...
BEGIN
    DBMS_OUTPUT.NEW_LINE;
     ...
     DBMS_OUTPUT.PUT_LINE('======>PRUEBA DEL TRIGGER verificar_estado_pista');
     INSERT INTO WET (ID_NEUMATICOS, ESTRIADO, ESTADO_PISTA) VALUES ('5', 'LIGHT', 'seco');
...
BEGIN
    DBMS_OUTPUT.NEW_LINE;
     ...
     DBMS_OUTPUT.PUT_LINE('======>PRUEBA DEL TRIGGER verificar_dni_empleado');
     INSERT INTO EMPLEADOS (DNI,F_INICIOCONTRATO, DIRECCION, NSS, SUELDO, NOMBRE, APELLIDOS, ESCUDID, ID_DIRIGENTE, JOB)
     VALUES('12345678A', '14-01-2020', 'AVENIDA', '46345G', '1550', 'SARA', 'JUAN', '1234G', '53817417Q','TECNICO');
...
BEGIN
   ...
   DBMS_OUTPUT.PUT_LINE('======>PRUEBA DEL TRIGGER fecha_InicioContrato');
   UPDATE EMPLEADOS SET F_INICIOCONTRATO='12-12-3000' WHERE DNI='31111111A';
